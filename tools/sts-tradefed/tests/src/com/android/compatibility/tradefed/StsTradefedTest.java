...
/**
 * Tests for sts-tradefed.
 */
public class StsTradefedTest extends TestCase {

    private static final String PROPERTY_NAME = "STS_ROOT";
    private static final String SUITE_FULL_NAME = "Security Test Suite";
    private static final String SUITE_NAME = "STS";
    ...
    public void testSuiteInfoLoad() throws Exception {
        ...
        File base = new File(root, "android-sts");
        base.mkdirs();
